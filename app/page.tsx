...
export default function Page(){
 ...
 return <main className="wrap">
  {submitted&&<div className="submitOverlay" role="dialog" aria-modal="true" aria-labelledby="submitSuccessTitle"><div className="submitSuccess"><div className="successIcon">✓</div><h2 id="submitSuccessTitle">Issue submitted successfully</h2><p>Your report has been received and saved.</p>{submitNote&&<p className="submitWarning">{submitNote}</p>}<button className="btn primary full" onClick={()=>{setSubmitted(false);setSubmitNote('')}}>OK</button></div></div>}
